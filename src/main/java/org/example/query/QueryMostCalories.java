...
/** A query that calculates the user that burned the most calories. */
public class QueryMostCalories extends QueryBetweenDates implements Consumer<User> {
    ...
    /**
     * Consumes a user to gets the information about its activities.
     *
     ...
     */
    public int hashCode() {
        return Objects.hash(super.hashCode(), this.maxUser, Double.valueOf(this.maxCalories));
    }
